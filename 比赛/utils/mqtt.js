...
export function createConnection() {
	...
	client.on('message', (topic, message) => {
		...
		if(topic==="testtopic/work"){
			// console.log("工作状态",message);
			store.dispatch("work/changeWork",message)}
		if(topic==="testtopic/tds"){
			// console.log("工作状态",message);
			store.commit("tds/RECEIVETDS",message)}
